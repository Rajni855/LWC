    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 8
      }, [api_text("Result:"), api_dynamic($cmp.result)]), api_element("p", {
        attrs: {
          "slot": "footer"
        },
        key: 9
      }, [api_text("Previous Result:"), api_dynamic($cmp.previousResult), api_text(" ")])])];
    }
    ...
    class Calculator extends lwc.LightningElement {
      ...
      onCompute(event) {
        if (event.target.label === 'Add') this.result = parseInt(this.firstnumber) + parseInt(this.secondnumber);else if (event.target.label === 'Subtract') this.result = this.firstnumber - this.secondnumber;else if (event.target.label === 'Multiply') this.result = this.firstnumber * this.secondnumber;else if (event.target.label === 'Divide') this.result = this.firstnumber / this.secondnumber;
