    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 2,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.onAdd))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Subtract",
        ...
        key: 3,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.onSubtract))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Multiply",
        ...
        key: 4,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.onMultiply))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Divide",
        ...
        key: 5,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.onDivide))
        }
      }, [])])]), api_element("p", {
        key: 8
    ...
    class Calculator extends lwc.LightningElement {
      ...
      onAdd() {
        this.result = parseInt(this.firstnumber) + parseInt(this.secondnumber); // this.previousResult.push(this.result);
      }

      onSubtract() {
        this.result = this.firstnumber - this.secondnumber; // this.previousResult.push(this.result);
      }
