Webruntime.define('lwc/userRegistrationForm', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".Header" + shadowSelector + "{font-size:18;color: #5e9ca0;}\n";
    }
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        className: $cmp.computedLabelClass,
        key: 0
      }, [api_dynamic($cmp.label)]), api_element("span", {
        classMap: {
        ...
        attrs: {
          "id": api_scoped_id("input"),
          "type": "range",
          "aria-describedby": `${api_scoped_id("message-id")}`,
          "min": $cmp.min,
          "max": $cmp.max,
          "step": $cmp.step
        },
        props: {
          "value": $cmp.computedValue,
          "disabled": $cmp.disabled
        },
        key: 4,
        on: {
          ...
          "touchmove": _m4 || ($ctx._m4 = api_bind($cmp.handleTouchMove))
        }
      }, []), api_element("span", {
        classMap: {
        ...
        key: 5
      }, [api_dynamic($cmp.formattedValue)])])]), $cmp._helpMessage ? api_element("div", {
        classMap: {
          "slds-form-element__help": true
        },
        attrs: {
          "id": api_scoped_id("message-id"),
          "aria-live": "assertive"
        },
        key: 8
      }, [api_dynamic($cmp._helpMessage)]) : null])];
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lightning-slider_slider-host",
      shadowAttribute: "lightning-slider_slider"
    };
    ...
    */
    ...
    class LightningSlider extends lwc.LightningElement {
      /**
      ...
      connectedCallback() {
        this.classList.add('slds-form-element'); // in mobile, we don't want ui:scroller to handle touch moves

        this.setAttribute('data-handles-touch', true);
        assert(this.label, `<lightning-slider> Missing required "label" attribute.`);
      }
      /**
      ...
      get formattedValue() {
        ...
        return numberFormat$1(formatConfig).format(this.computedValue);
      }
      ...
      handleChange(event) {
        event.stopPropagation(); // The input event fires continually for every value change while the change event gets
      ...
      get computedLabelClass() {
        ...
        classes.add(this.isLabelHidden ? 'slds-assistive-text' : 'slds-slider-label__label');
        return classes.toString();
    ...
    lwc.registerDecorators(LightningSlider, {
      publicProps: {
        size: {
          config: 0
        },
    ...
    var _lightningSlider = lwc.registerComponent(LightningSlider, {
      tmpl: _tmpl$k
    });
    ...
    if (_implicitStylesheets$6) {
      tmpl$m.stylesheets.push.apply(tmpl$m.stylesheets, _implicitStylesheets$6);
    }
    ...
    class LightningCombobox extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.label = void 0;
        this.dropdownAlignment = 'left';
        this.placeholder = i18n$b.placeholder;
        this.messageWhenValueMissing = void 0;
        this.name = void 0;
        this._items = [];
        this._variant = void 0;
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 0
      }, [api_text("User Registration Form")])]), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "type": "text",
          "name": "Firstname",
          "label": "First Name"
        ...
        key: 2,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.captureInput1))
        }
        ...
        key: 3,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.captureInput2))
        }
      }, []), api_custom_element("lightning-slider", _lightningSlider, {
        props: {
          "label": "Age"
        },
        key: 4
        ...
        key: 5,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.captureInput2))
        }
        ...
        props: {
          "label": "Show Previous result",
          "type": "checkbox"
        },
        key: 7,
        on: {
          "change": _m4 || ($ctx._m4 = api_bind($cmp.captureShowResult))
        }
      }, [])])];
    }
