    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 2,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.onCompute))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": $cmp.subtractLabel,
          "iconName": "utility:edit",
          "variant": "brand"
        },
        key: 3,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.onCompute))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": $cmp.multiplyLabel,
          "iconName": "utility:edit",
          "variant": "brand"
        },
        key: 4,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.onCompute))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": $cmp.divideLabel,
          "iconName": "utility:edit",
          "variant": "brand"
        },
        key: 5,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.onCompute))
        }
      }, [])])]), api_element("br", {
        key: 8
      }, []), api_custom_element("lightning-input", _lightningInput, {
        ...
        key: 9,
        on: {
          "change": _m6 || ($ctx._m6 = api_bind($cmp.captureShowResult))
        }
      }, []), $cmp.showPreviousResult ? api_iterator($cmp.previousResult, function (result) {
        return api_element("li", {
          key: api_key(10, result.num1)
        }, [api_dynamic(result.num1), api_text(" "), api_dynamic(result.operator), api_text(" "), api_dynamic(result.num2), api_text(" = "), api_dynamic(result.num3)]);
      }) : [], api_element("p", {
        attrs: {
          "slot": "footer"
        },
        key: 11
      }, [api_text("Result:"), api_dynamic($cmp.result), api_text(" ")])]))];
    }
    ...
    class Calculator extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.result = void 0;
        this.showPreviousResult = void 0;
        this.addLabel = 'Add';
        this.subtractLabel = 'Subtract';
        this.multiplyLabel = 'Multiply';
        this.divideLabel = 'Divide';
        this.previousResult = [];
      }
      ...
      onCompute(event) {
        this.result = event.target.label === 'Add' ? parseInt(this.firstnumber) + parseInt(this.secondnumber) : event.target.label === 'Subtract' ? this.firstnumber - this.secondnumber : event.target.label === 'Multiply' ? this.firstnumber * this.secondnumber : event.target.label === 'Divide' ? this.firstnumber / this.secondnumber : 0;
        const newResult = {
    ...
    lwc.registerDecorators(Calculator, {
      ...
      fields: ["firstnumber", "secondnumber", "result", "showPreviousResult", "addLabel", "subtractLabel", "multiplyLabel", "divideLabel"]
    });
