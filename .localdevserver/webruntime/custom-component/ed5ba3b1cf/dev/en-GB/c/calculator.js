Webruntime.define('lwc/calculator', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    class Calculator extends lwc.LightningElement {
      ...
      onCompute(event) {
        if (event.target.label === 'Add') this.result = parseInt(this.firstnumber) + parseInt(this.secondnumber);else if (event.target.label === 'Subtract') this.result = this.firstnumber - this.secondnumber;else if (event.target.label === 'Multiply') this.result = this.firstnumber * this.secondnumber;
